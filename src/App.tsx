          ...
          return (
            ...
            >
              ...
              {note.length === 0 ? (
                ...
                >
                  {note.map((n, index) => {
                    const col = isMobile ? 0 : index % columns;
                    const row = isMobile ? index : Math.floor(index / columns);

                    const leftPercent = isMobile
                      ? 50
                      : columns === 1
                      ? 50
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          animation: `${driftName} ${8 + (index % 4)}s ease-in-out infinite`,
