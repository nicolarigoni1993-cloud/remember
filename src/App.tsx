...
const [, setTurnoManuale] = useState(false);
...
function salvaTurno() {
  ...
  const oreOrdManuali = parseOreItaliane(turnoOreOrd);
  const oreStra = turnoOreStraord.trim() === "" ? 0 : parseOreItaliane(turnoOreStraord);

  if (oreOrdManuali === null || oreOrdManuali <= 0) {
    alert("Inserisci ore ordinarie effettive valide.");
    return;
  }
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(700px 240px at 0% 0%, rgba(16,185,129,0.08), transparent 60%), radial-gradient(700px 240px at 100% 0%, rgba(79,70,229,0.08), transparent 60%)",
            pointerEvents: "none",
          }}
        />

        <div style={{ position: "relative", zIndex: 1, display: "grid", gap: isMobileConsulta ? 10 : 14 }}>
          <div
            style={{
              display: "flex",
              justifyContent: "space-between",
          ...
          >
            <div style={{ minWidth: 0 }}>
              ...
              <input
                ...
                onChange={(e) =>
                  setFiltroFinanzaGrafico((prev) => ({ ...prev, dal: e.target.value }))
                }
                style={{
                  ...inputLight(false),
                  width: "100%",
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <input
                ...
                onChange={(e) =>
                  setFiltroFinanzaGrafico((prev) => ({ ...prev, al: e.target.value }))
                }
                style={{
                  ...inputLight(false),
                  width: "100%",
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <select
                ...
                onChange={(e) =>
                  setFiltroFinanzaGrafico((prev) => ({ ...prev, categoria: e.target.value }))
                }
                style={{
                  ...inputLight(false),
                  width: "100%",
            ...
            >
              {uscitePerCategoriaGrafico.length === 0 ? (
                ...
                uscitePerCategoriaGrafico.map((item, index) => {
                  const perc =
                    totaleGraficoUscite > 0 ? (item.totale / totaleGraficoUscite) * 100 : 0;
          ...
          >
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <select
                ...
                onChange={(e) =>
                  setFiltroFinanzaLista((prev) => ({ ...prev, categoria: e.target.value }))
                }
                style={{
                  ...inputLight(false),
                  width: "100%",
                  ...
                  >
                    ...
                    >
                      ...
                      {mov.nota && (
                        ...
                        >
                          <span style={{ fontWeight: 950, color: "rgba(51,65,85,0.92)" }}>
                            Nota:
                          </span>{" "}
                          {mov.nota}
                        </div>
    ...
    >
      ...
      >
        <div style={{ display: "grid", gap: 6 }}>
          ...
          >
            Rapido = preset turno. Avanzato = orari, pausa, ore, note e dettagli.
          </div>
        </div>
        ...
        <div style={{ ...sx.content, display: "grid", gap: 18 }}>
          ...
          {turnoAvanzato && (
            ...
            >
              ...
              <MiniCalendarioSettimanaTurni turni={turni} onEditTurno={apriModificaTurno} />
            </div>
          )}
          ...
          >
            <div style={sx.sectionLabel}>Data turno</div>
          ...
          >
            <div style={sx.sectionLabel}>Tipo turno</div>
          ...
          {turnoTipo === "lavoro" && (
            <>
              {!turnoAvanzato && (
                ...
                >
                  <div style={sx.sectionLabel}>Turno rapido</div>
              ...
              {turnoAvanzato && (
                ...
                >
                  <div style={sx.sectionLabel}>Orario di lavoro</div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ marginTop: 8, fontSize: 11, fontWeight: 800, opacity: 0.62, color: "rgba(15,23,42,0.72)" }}>
                        Si calcola automaticamente dagli orari, ma puoi correggerla manualmente.
                      </div>
                    </div>
